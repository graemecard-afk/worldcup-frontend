...
>
  ...
  <DashboardPage
    ...
    loadTournamentAndMatches={loadTournamentAndMatches}
    handleScoreChange={handleScoreChange}
    savePrediction={savePrediction}
    refreshMatchesAndPredictions={refreshMatchesAndPredictions}
    TitleRow={TitleRow}
    Sub={Sub}
    StatusBadge={StatusBadge}
    AdminFinalizeMatchPanel={AdminFinalizeMatchPanel}
